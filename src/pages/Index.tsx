...
export default function Index() {
  const stats = [
    { title: "Total Connections", value: "247", icon: Users, trend: "+12 this week" },
    { title: "Events Attended", value: "18", icon: Calendar, trend: "3 upcoming" },
    { title: "Messages", value: "42", icon: MessageSquare, trend: "8 unread" },
    { title: "Profile Views", value: "1.2K", icon: Eye, trend: "+18% this month" },
  ];
          ...
          <CardContent>
            <div className="space-y-4">
              {recentActivities.map((activity, index) => (
                <div
                  key={index}
                  className="flex items-start gap-4 rounded-lg border border-border p-4 transition-all hover:border-primary/50 hover:shadow-soft"
                >
